...
public class cloud_behav : MonoBehaviour 
{
    ...
    void spawn_cloud(int mode)
    {
        if (cloud_count_cur < cloud_count_max)
        {
            ...
            {
                case 1: new_cloud = Instantiate(cloud_1, transform); break;
                case 2: new_cloud = Instantiate(cloud_2, transform); break;
                case 3: new_cloud = Instantiate(cloud_3, transform); break;
            }
